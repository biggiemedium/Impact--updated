...
public class ConfigUtils {
    ...
    public ConfigUtils() {
        this.Osiris = new File(this.mc.mcDataDir + File.separator + "ImpactPlus");
        if (!this.Osiris.exists())
            this.Osiris.mkdirs();
        this.Settings = new File(this.mc.mcDataDir + File.separator + "ImpactPlus" + File.separator + "Settings");
