...
public class Panel {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if ((ImpactPlus.getInstance()).settingsManager.getSettingByID("ClickGuiStyle").getValString().equals("Old")) {
      ...
      ImpactPlus.fontRenderer.drawCenteredStringWithShadow(this.title, (int)(this.x + this.width / 2.0D), (int)(this.y + this.height / 2.0D - 6.0D), ColorUtil.getClickGUIColor().brighter().getRGB());
      ...
      ImpactPlus.fontRenderer.drawStringWithShadow(title22, (int)(this.x + 1.0D), (int)(this.y + 4.0D), ColorUtil.getClickGUIColor().brighter().getRGB());
    } 
