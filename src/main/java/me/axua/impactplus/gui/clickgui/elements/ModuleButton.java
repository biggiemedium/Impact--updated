...
public class ModuleButton {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if ((ImpactPlus.getInstance()).settingsManager.getSettingByID("ClickGuiStyle").getValString().equals("WeepCraft")) {
      ...
      ImpactPlus.fontRenderer.drawStringWithShadow(this.mod.getName(), (int)this.x, (int)this.y, i);
    } else {
      ImpactPlus.fontRenderer.drawCenteredStringWithShadow(this.mod.getName(), (int)(this.x + this.width / 2.0D), (int)(this.y + this.height / 2.0D - 5.0D), i);
    } 
  }
