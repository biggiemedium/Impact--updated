...
public class ElementSlider extends Element {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    // (getModuleButton().getWidth() * (value.getValue() - min) / (max - min));
    ...
    ImpactPlus.fontRenderer.drawString(this.setstrg, (int)(this.x + 1.0D), (int)this.y, -1);
    ImpactPlus.fontRenderer.drawString(displayval, (int)(this.x + this.width - ImpactPlus.fontRenderer.getStringWidth(displayval) - 2.0D), (int)this.y, -1);
    Gui.drawRect((int)this.x, (int)this.y + 12, (int)this.x + (int)this.width, (int)this.y + 13, -15724528);
    Gui.drawRect((int)this.x, (int)this.y + 12, (int)this.x + (int)width * (int)percentBar, (int)this.y + 13, color);
