...
public class ElementComboBox extends Element {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    ImpactPlus.fontRenderer.drawCenteredString(this.setstrg, (int)(this.x + this.width / 2.0D), (int)(this.y + 7.0D - 5.0D), -1);
    int clr1 = color;
    ...
    if (this.comboextended) {
      ...
      for (String sld : this.set.getOptions()) {
        ...
        ImpactPlus.fontRenderer.drawCenteredString(elementtitle, (int)(this.x + this.width / 2.0D), (int)ay, -1);
