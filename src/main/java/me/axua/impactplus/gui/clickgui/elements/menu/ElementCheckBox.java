...
public class ElementCheckBox extends Element {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    ImpactPlus.fontRenderer.drawString(this.setstrg, (int)(this.x + this.width - ImpactPlus.fontRenderer.getStringWidth(this.setstrg) - 2.0D), (int)(this.y + (FontUtil.getFontHeight() / 2.0F) - 0.5D - 2.0D), -1);
