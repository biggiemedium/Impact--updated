...
public class HoleComponent extends Panel {
  ...
  public void drawHud() {
    ...
    } else if (this.mod.fontRenderer.getValBoolean()) {
      ImpactPlus.fontRenderer.drawStringWithShadow(text(), (int)this.x, (int)this.y, this.color.getRGB());
    } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    doStuff();
    double w = (ImpactPlus.fontRenderer.getStringWidth(text()) + 2.0F);
