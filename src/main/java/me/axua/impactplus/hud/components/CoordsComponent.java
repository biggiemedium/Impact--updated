...
public class CoordsComponent extends Panel {
  ...
  public void drawHud() {
    ...
    float hi1 = ImpactPlus.fontRenderer.getStringWidth(xcoordok);
    float hi2 = ImpactPlus.fontRenderer.getStringWidth(ycoordok);
    float hi3 = ImpactPlus.fontRenderer.getStringWidth(zcoordok);
    ...
    if (this.mod.rainbow.getValBoolean())
      c = Rainbow.getColor(); 
    float hi = ImpactPlus.fontRenderer.getStringWidth(getCoords());
    float hdsfgadgfa = ImpactPlus.fontRenderer.getStringWidth(getCoords2());
    ...
    if (this.mod.style.getValString().equals("Future")) {
      if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(xcoordok, (float)this.x - hi1, (float)this.y, this.text.getRGB());
          ImpactPlus.fontRenderer.drawStringWithShadow(ycoordok, (float)this.x - hi2, (float)this.y + 10.0F, this.text.getRGB());
          ImpactPlus.fontRenderer.drawStringWithShadow(zcoordok, (float)this.x - hi3, (float)this.y + 20.0F, this.text.getRGB());
        } else {
        ...
        ImpactPlus.fontRenderer.drawStringWithShadow(xcoordok, (float)this.x, (float)this.y, this.text.getRGB());
        ImpactPlus.fontRenderer.drawStringWithShadow(ycoordok, (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
        ImpactPlus.fontRenderer.drawStringWithShadow(zcoordok, (float)this.x, (float)this.y + 20.0F, this.text.getRGB());
      } else {
      ...
      if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x - hdsfgadgfa, (float)this.y, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x - hi1111, (float)this.y, this.text.getRGB());
        } 
      } else if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x, (float)this.y, this.text.getRGB());
      } else {
      ...
      if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x - hi, (float)this.y, this.text.getRGB());
      } else {
        mc.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x - hi111, (float)this.y, this.text.getRGB());
      } 
    } else if (this.font) {
      ImpactPlus.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x, (float)this.y, this.text.getRGB());
    } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    doStuff();
    double w = ImpactPlus.fontRenderer.getStringWidth(getCoords());
    ...
    if (this.extended) {
      ...
      if (this.mod.style.getValString().equals("Future")) {
        if (this.mod.right.getValBoolean()) {
          if (this.font) {
            ImpactPlus.fontRenderer.drawStringWithShadow(xcoordok, (float)this.x - hi1, (float)this.y + 10.0F, this.text.getRGB());
            ImpactPlus.fontRenderer.drawStringWithShadow(ycoordok, (float)this.x - hi2, (float)this.y + 20.0F, this.text.getRGB());
            ImpactPlus.fontRenderer.drawStringWithShadow(zcoordok, (float)this.x - hi3, (float)this.y + 30.0F, this.text.getRGB());
          } else {
          ...
          ImpactPlus.fontRenderer.drawStringWithShadow(xcoordok, (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
          ImpactPlus.fontRenderer.drawStringWithShadow(ycoordok, (float)this.x, (float)this.y + 20.0F, this.text.getRGB());
          ImpactPlus.fontRenderer.drawStringWithShadow(zcoordok, (float)this.x, (float)this.y + 30.0F, this.text.getRGB());
        } else {
        ...
        if (this.mod.right.getValBoolean()) {
          if (this.font) {
            ImpactPlus.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x - hdsfgadgfa, (float)this.y + 10.0F, this.text.getRGB());
          } else {
            mc.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x - hi1111, (float)this.y + 10.0F, this.text.getRGB());
          } 
        } else if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(getCoords2(), (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
        } 
      } else if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x - hi, (float)this.y + 10.0F, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x - hi111, (float)this.y + 10.0F, this.text.getRGB());
        } 
      } else if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(getCoords(), (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
      } else {
