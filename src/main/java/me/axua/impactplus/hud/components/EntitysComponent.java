    ...
    entityCounts.entrySet().stream()
      ...
      .forEach(entry -> {
          if (this.mod.right.getValBoolean()) {
            if (font) {
              ImpactPlus.fontRenderer.drawStringWithShadow(entry, (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(entry), ((int)(float)this.y + this.count), this.c.getRGB());
            } else {
            ...
            ImpactPlus.fontRenderer.drawStringWithShadow(entry, (int)(float)this.x, ((int)(float)this.y + this.count), this.c.getRGB());
          } else {
    ...
    if (this.extended) {
      ...
      entityCounts.entrySet().stream()
        ...
        .forEach(entry -> {
            if (this.mod.right.getValBoolean()) {
              if (font) {
                ImpactPlus.fontRenderer.drawStringWithShadow(entry, (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(entry), ((int)(float)this.y + this.count + 10), this.c.getRGB());
              } else {
              ...
              ImpactPlus.fontRenderer.drawStringWithShadow(entry, (int)(float)this.x, ((int)(float)this.y + this.count + 10), this.c.getRGB());
            } else {
