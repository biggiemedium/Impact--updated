...
public class TextRadarComponent extends Panel {
  ...
  public void drawHud() {
    ...
    boolean font = this.mod.fontRenderer.getValBoolean();
    this.count = 0;
      ...
      .forEach(e -> {
          ...
          if (!this.mod.distance.getValBoolean()) {
            if (this.mod.right.getValBoolean()) {
              if (font) {
                ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName(), (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(this.fristr + e.getName() + this.s), ((int)(float)this.y + this.count), this.c.getRGB());
              } else {
              ...
              ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName(), (int)(float)this.x, ((int)(float)this.y + this.count), this.c.getRGB());
            } else {
            ...
            if (font) {
              ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName() + this.h, (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(this.fristr + e.getName() + this.s + this.h), ((int)(float)this.y + this.count), this.c.getRGB());
            } else {
            ...
            ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName() + this.h, (int)(float)this.x, ((int)(float)this.y + this.count), this.c.getRGB());
          } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    doStuff();
    double w = (ImpactPlus.fontRenderer.getStringWidth(this.s) + 2.0F);
      ...
      mc.world.loadedEntityList.stream()
        ...
        .forEach(e -> {
            ...
            if (!this.mod.distance.getValBoolean()) {
              if (this.mod.right.getValBoolean()) {
                if (font) {
                  ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName(), (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(this.fristr + e.getName() + this.s), ((int)(float)this.y + 10 + this.count), this.c.getRGB());
                } else {
                ...
                ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName(), (int)(float)this.x, ((int)(float)this.y + 10 + this.count), this.c.getRGB());
              } else {
              ...
              if (font) {
                ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName() + this.h, (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(this.fristr + e.getName() + this.s + this.h), ((int)(float)this.y + 10 + this.count), this.c.getRGB());
              } else {
              ...
              ImpactPlus.fontRenderer.drawStringWithShadow(this.fristr + this.s + e.getName() + this.h, (int)(float)this.x, ((int)(float)this.y + 10 + this.count), this.c.getRGB());
            } else {
