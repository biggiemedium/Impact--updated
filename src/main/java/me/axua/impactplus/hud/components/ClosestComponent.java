...
public class ClosestComponent extends Panel {
  ...
  public void drawHud() {
    ...
    EntityPlayer l_Player = mc.world.playerEntities.stream()
            .filter(p_Entity -> p_Entity != null)
            .filter(p_Entity -> p_Entity instanceof EntityPlayer)
            .filter(p_Entity -> (p_Entity != mc.player))
            .min(Comparator
                    .comparing(p_Entity -> Float.valueOf(mc.player.getDistance(p_Entity))))
            .orElse(null);
    ...
    if (l_Player != null) {
      ...
      if (Friends.isFriend(Name)) {
        ImpactPlus.fontRenderer.drawStringWithShadow(ChatFormatting.AQUA + "Friend" + ChatFormatting.RESET + " | " + numbercf + Ping + "ms" + ChatFormatting.RESET + " | " + numbercf + Distance, 0.0F, -(Minecraft.getMinecraft()).fontRenderer.FONT_HEIGHT, this.text.getRGB());
        ...
        ImpactPlus.fontRenderer.drawStringWithShadow(ChatFormatting.RED + "Threat" + ChatFormatting.RESET + " | " + numbercf + Ping + "ms" + ChatFormatting.RESET + " | " + numbercf + Distance, 0.0F, -(Minecraft.getMinecraft()).fontRenderer.FONT_HEIGHT, this.text.getRGB());
      } else if (helm2.equals("Diamond Helmet") && body2.equals("Elytra") && leggings2.equals("Diamond Leggings") && boots2.equals("Diamond Boots")) {
        ImpactPlus.fontRenderer.drawStringWithShadow(ChatFormatting.YELLOW + "Wasp" + ChatFormatting.RESET + " | " + numbercf + Ping + "ms" + ChatFormatting.RESET + " | " + numbercf + Distance, 0.0F, -(Minecraft.getMinecraft()).fontRenderer.FONT_HEIGHT, this.text.getRGB());
      } else if (helm2.equals("Air") && body2.equals("Air") && leggings2.equals("Air") && boots2.equals("Air")) {
        ImpactPlus.fontRenderer.drawStringWithShadow(ChatFormatting.GREEN + "Naked" + ChatFormatting.RESET + " | " + numbercf + Ping + "ms" + ChatFormatting.RESET + " | " + numbercf + Distance, 0.0F, -(Minecraft.getMinecraft()).fontRenderer.FONT_HEIGHT, this.text.getRGB());
      } else {
        ImpactPlus.fontRenderer.drawStringWithShadow(ChatFormatting.LIGHT_PURPLE + "Newfag" + ChatFormatting.RESET + " | " + numbercf + Ping + "ms" + ChatFormatting.RESET + " | " + numbercf + Distance, 0.0F, -(Minecraft.getMinecraft()).fontRenderer.FONT_HEIGHT, this.text.getRGB());
      } 
      GL11.glPopMatrix();
      ImpactPlus.fontRenderer.drawStringWithShadow(Name, ((int)(float)this.x + 45), ((int)(float)this.y + 2), this.text.getRGB());
      ...
      if (l_Player.isPotionActive(MobEffects.STRENGTH)) {
        ...
        ImpactPlus.fontRenderer.drawStringWithShadow(TextFormatting.RED + "Strength " + amplifier + TextFormatting.RESET + numbercf + " " + minutes + ":" + seconds, 0.0F, 0.0F, this.text.getRGB());
      } else {
        ImpactPlus.fontRenderer.drawStringWithShadow(TextFormatting.RED + "Strength" + TextFormatting.RESET + numbercf + " None", 0.0F, 0.0F, this.text.getRGB());
      } 
      GL11.glPopMatrix();
      GL11.glPushMatrix();
      ...
      if (l_Player.isPotionActive(MobEffects.WEAKNESS)) {
        ...
        String minutes = format1.format(p3);
        String seconds = format2.format(p1);
        ImpactPlus.fontRenderer.drawStringWithShadow(TextFormatting.GRAY + "Weakness " + amplifier + TextFormatting.RESET + numbercf + " " + minutes + ":" + seconds, 0.0F, 0.0F, this.text.getRGB());
      } else {
        ImpactPlus.fontRenderer.drawStringWithShadow(TextFormatting.GRAY + "Weakness" + TextFormatting.RESET + numbercf + " None", 0.0F, 0.0F, this.text.getRGB());
      } 
      GL11.glPopMatrix();
      if (Healt == 20) {
        GL11.glPushMatrix();
        ...
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -11141291);
        GL11.glPopMatrix();
      ...
      if (Healt == 18) {
        ...
        GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -16733696);
        GL11.glPopMatrix();
      ...
      if (Healt == 16) {
        ...
        GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -171);
        GL11.glPopMatrix();
      ...
      if (Healt == 12) {
        ...
        GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -22016);
        GL11.glPopMatrix();
      ...
      if (Healt == 8) {
        ...
        GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -43691);
        GL11.glPopMatrix();
      ...
      if (Healt == 5) {
        ...
        GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
        GL11.glScaled(0.9D, 0.9D, 0.9D);
        ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -5636096);
        GL11.glPopMatrix();
      ...
      if (Healt > 20) {
        ...
        if (Healt == 21) {
          ...
          GL11.glTranslated(((int)(float)this.x + 158), ((int)(float)this.y + 81), 0.0D);
          GL11.glScaled(0.9D, 0.9D, 0.9D);
          ImpactPlus.fontRenderer.drawStringWithShadow(Health, -ImpactPlus.fontRenderer.getStringWidth(Health), 0.0F, -11141121);
          GL11.glPopMatrix();
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (this.extended) {
      ...
      EntityPlayer l_Player = mc.world.playerEntities
              .stream()
              .filter(p_Entity -> p_Entity instanceof EntityPlayer)
              .filter(p_Entity -> (p_Entity != mc.player))
              .min(Comparator.comparing(p_Entity -> Float.valueOf(mc.player.getDistance(p_Entity))))
              .orElse(null);
      ...
      if (l_Player == null) {
        ...
        GL11.glPopMatrix();
        ImpactPlus.fontRenderer.drawStringWithShadow(Name, ((int)(float)this.x + 45), ((int)(float)this.y + 12), this.text.getRGB());
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
