...
public class ModListComponent extends Panel {
  ...
  public void drawHud() {
    ...
    ModuleManager.getModules()
      ...
      .sorted(Comparator.comparing(module -> Float.valueOf(ImpactPlus.fontRenderer.getStringWidth(module.getName() + ChatFormatting.GRAY + " " + module.getHudInfo()) * -1.0F)))
      .forEach(m -> {
          String bruhmoment = m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo();
          int bruhmomentnumber = (int)ImpactPlus.fontRenderer.getStringWidth(m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo());
          int bruhmomentnumber2 = (int)ImpactPlus.fontRenderer.getStringHeight(m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo());
          if (this.mod.fontRenderer.getValBoolean()) {
            if (this.mod.sortUp.getValBoolean()) {
              if (this.mod.right.getValBoolean()) {
                ...
                ImpactPlus.fontRenderer.drawStringWithShadow(m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo(), (int)(float)this.x - ImpactPlus.fontRenderer.getStringWidth(m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo()), ((int)(float)this.y + this.modCount * 9), this.c.getRGB());
              } else {
                if (this.mod.rects.getValBoolean()) {
                ...
                ImpactPlus.fontRenderer.drawStringWithShadow(m.getName() + ChatFormatting.GRAY + " " + m.getHudInfo(), (int)(float)this.x, ((int)(float)this.y + this.modCount * 9), this.c.getRGB());
              } 
              this.lolok += 9;
              this.modCount++;
            } else {
