...
public class ServerIpComponent extends Panel {
  ...
  public void drawHud() {
    ...
    float hi = ImpactPlus.fontRenderer.getStringWidth(this.serve);
    float hi2 = mc.fontRenderer.getStringWidth(this.serve);
    if (this.mod.right.getValBoolean()) {
      if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(this.serve, (float)this.x - hi, (float)this.y, this.text.getRGB());
      } else {
        mc.fontRenderer.drawStringWithShadow(this.serve, (float)this.x - hi2, (float)this.y, this.text.getRGB());
      } 
    } else if (this.font) {
      ImpactPlus.fontRenderer.drawStringWithShadow(this.serve, (float)this.x, (float)this.y, this.text.getRGB());
    } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (mc.getCurrentServerData() == null)
      this.serve = "Ip " + numbercf + "ERROR"; 
    double w = (ImpactPlus.fontRenderer.getStringWidth(this.serve) + 2.0F);
    ...
    if (this.extended) {
      ...
      if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(this.serve, (float)this.x - hi, (float)this.y + 10.0F, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(this.serve, (float)this.x - hi2, (float)this.y + 10.0F, this.text.getRGB());
        } 
      } else if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(this.serve, (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
      } else {
