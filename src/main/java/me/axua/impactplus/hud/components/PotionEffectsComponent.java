  ...
  public void drawHud() {
    ...
    try {
      mc.player.getActivePotionEffects().forEach(effect -> {
            ...
            float hi = ImpactPlus.fontRenderer.getStringWidth(s);
            float hi2 = mc.fontRenderer.getStringWidth(s);
            if (this.mod.fontRenderer.getValBoolean()) {
              if (this.mod.normalcolour.getValBoolean()) {
                if (this.mod.sortUp.getValBoolean()) {
                  if (this.mod.right.getValBoolean()) {
                    ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x - hi, (float)this.y + (this.count * 10), color);
                  } else {
                    ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x, (float)this.y + (this.count * 10), color);
                  } 
                  this.count++;
                } else {
                  if (this.mod.right.getValBoolean()) {
                ...
                if (this.mod.right.getValBoolean()) {
                  ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x - hi, (float)this.y + (this.count * 10), this.c.getRGB());
                } else {
                  ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x, (float)this.y + (this.count * 10), this.c.getRGB());
                } 
                this.count++;
              } else {
                if (this.mod.right.getValBoolean()) {
        ...
        mc.player.getActivePotionEffects().forEach(effect -> {
              ...
              if (this.mod.fontRenderer.getValBoolean()) {
                if (this.mod.normalcolour.getValBoolean()) {
                  if (this.mod.sortUp.getValBoolean()) {
                    if (this.mod.right.getValBoolean()) {
                      ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x - hi, (float)this.y + (this.count * 10) + 10.0F, color);
                    } else {
                      ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x, (float)this.y + (this.count * 10) + 10.0F, color);
                    } 
                    this.count++;
                  } else {
                    if (this.mod.right.getValBoolean()) {
                  ...
                  if (this.mod.right.getValBoolean()) {
                    ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x - hi, (float)this.y + (this.count * 10) + 10.0F, this.c.getRGB());
                  } else {
                    ImpactPlus.fontRenderer.drawStringWithShadow(s, (float)this.x, (float)this.y + (this.count * 10) + 10.0F, this.c.getRGB());
                  } 
                  this.count++;
                } else {
                  if (this.mod.right.getValBoolean()) {
