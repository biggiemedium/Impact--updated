...
public class GappsComponent extends Panel {
  ...
  public void drawHud() {
    ...
    if (this.mod.mode.getValString().equalsIgnoreCase("Item")) {
      ...
      float hi = ImpactPlus.fontRenderer.getStringWidth(this.gaps);
      float hi2 = mc.fontRenderer.getStringWidth(this.gaps);
      if (this.mod.right.getValBoolean()) {
        if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x - hi, (float)this.y, this.text.getRGB());
        } else {
          mc.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x - hi2, (float)this.y, this.text.getRGB());
        } 
      } else if (this.font) {
        ImpactPlus.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x, (float)this.y, this.text.getRGB());
      } else {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    doStuff();
    double w = (ImpactPlus.fontRenderer.getStringWidth(this.gaps) + 2.0F);
    ...
    if (this.extended) {
      ...
      if (this.mod.mode.getValString().equalsIgnoreCase("Item")) {
        ...
        if (this.mod.right.getValBoolean()) {
          if (this.font) {
            ImpactPlus.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x - hi, (float)this.y + 10.0F, this.text.getRGB());
          } else {
            mc.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x - hi2, (float)this.y + 10.0F, this.text.getRGB());
          } 
        } else if (this.font) {
          ImpactPlus.fontRenderer.drawStringWithShadow(this.gaps, (float)this.x, (float)this.y + 10.0F, this.text.getRGB());
        } else {
